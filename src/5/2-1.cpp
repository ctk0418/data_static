...
#include <c:\\simulated_book\\include_dll\DLL_usage_function_name.cpp>
	 ...
	 double mu1,c1,mu2,sigma2,mu3,sigma3;
...
#include <c:\\simulated_book\\include_dll\\DLL_function_load.cpp>
       ...
       Joint_plotx('X',1,'Y',1,data1,data2,n,5);
       Joint_plotx('X',1,'Y',2,data1,data3,n,5);
       Joint_plotx('Y',1,'Y',2,data2,data3,n,5);
       printf(" 排序.....\n");
       Sortx(0,n,data1);
       printf(" 完成排序.....\n");
	   Plotx(data1,n,'X',1); 
