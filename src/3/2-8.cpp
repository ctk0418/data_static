...
int main() {  
     double ret_function,count1; // ㄧ计 
     double lower1,upper1,lower2,upper2,sum,area,sumfunction,X1,X2,tepX1;
     int n=1000000000,i;// n琌家览Ω计 
     char *ss;
     ...
     { 
       ...
       if (X2<tepX1*cos(X1*M_PI) || X1*cos(X1*M_PI)<X2) { --i; continue; } //戈ぃ才
