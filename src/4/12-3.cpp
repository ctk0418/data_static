...
#include <c:\\simulated_book\\include_dll\DLL_usage_function_name.cpp>
	 ...
	 double alpha1,beta1,lamda2,mu2;
...
#include <c:\\simulated_book\\include_dll\\DLL_function_load.cpp>
     ...
     alpha1=-10;beta1=10; lamda2=0.2;mu2=0;
     j=0;
     for(x1=-1000000;x1<1000000;x1=x1+1)
     {
     	pdf=ret_DE_pdf(lamda2,mu2,x1);
     ...
     { 
       ...
       pdfx2=ret_DE_pdf(lamda2,mu2,X2);
       pdf=pdfx1*pdfx2;
       if (pdf<=0) { --i; continue;    }
